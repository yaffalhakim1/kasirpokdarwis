...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Kasir E-Ticket<sup></sup></div>
    </a>
    ...
    <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="index.php?page=barang">Tiket</a>
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <!-- <h5 class="d-lg-block d-block  mt-2"><b><?php echo $toko['nama_toko']; ?>, <?php echo $toko['alamat_toko']; ?></b></h5> -->
            <h5 class="d-block mt-2">
                <b><?php echo $toko['nama_toko']; ?></b>
                <span class="d-lg-none">
                    <!-- This will be hidden on screens larger than large (lg) -->
                    E-ticket
                </span>
                <span class="d-none d-lg-inline">
                    <!-- This will be hidden on screens smaller than large (lg) -->
